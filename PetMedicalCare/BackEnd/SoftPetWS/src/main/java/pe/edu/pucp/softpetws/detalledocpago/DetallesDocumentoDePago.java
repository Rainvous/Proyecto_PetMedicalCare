package pe.edu.pucp.softpetws.detalledocpago;
...
@WebService(serviceName = "DetallesDocumentoDePago")
public class DetallesDocumentoDePago {

    private final DetalleDocumentoDePagoBo detalleDocumentoBo;

    public DetallesDocumentoDePago() {
