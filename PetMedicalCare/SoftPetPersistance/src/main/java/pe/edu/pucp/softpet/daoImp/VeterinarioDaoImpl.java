...
public class VeterinarioDaoImpl extends DaoBaseImpl implements VeterinarioDao {
    ...
    protected void incluirValorDeParametrosParaInsercion() throws SQLException {
        ...
        this.statement.setInt(2, this.veterinario.getEspecialidadId());
        this.statement.setDate(3, this.veterinario.getFechaContratacion());
        this.statement.setString(4, this.veterinario.getEstado());
        this.statement.setString(5, this.veterinario.getEspecialidad());
        this.statement.setInt(6, this.veterinario.getActivo() ? 1 : 0);
    }
    ...
    protected void incluirValorDeParametrosParaModificacion() throws SQLException {
        ...
        this.statement.setInt(7, this.veterinario.getVeterinarioId());
    }
    ...
    protected void instanciarObjetoDelResultSet() throws SQLException {
        ...
        this.veterinario.setEspecialidadId(this.resultSet.getInt("ESPECIALIDAD_ID"));
