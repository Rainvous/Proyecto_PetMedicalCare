...
<asp:Content ID="ContentMain" ContentPlaceHolderID="cphContenido" runat="server">
    <%-- Contenido de Mi Agenda --%>
    <%-- Cabecera con título (ya no necesita iconos de acción, están en Master) --%>
    <div class="page-header">
        <div class="page-header-title">
            <h1>Mi Agenda de Citas</h1>
            <p class="text-muted">Gestiona tus consultas del día.</p>
        </div>
        <%-- Quitamos page-header-actions --%>
    </div>
    
    <%-- Barra selectora de fecha --%>
    <div class="date-selector-bar">
        ...
        <div class="date-selector-nav d-flex">
            ...
            <asp:Button ID="btnHoy" runat="server" OnClick="btnHoy_Click" CssClass="btn btn-primary btn-hoy" style="margin-left: 15px;" Text="<i class='fas fa-calendar-check me-1'></i> Hoy" /> <%-- Added me-1 --%>
        </div>
    </div>
